				...
				<ul class="sidebar-menu">
					<li class="treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							...
							<li><a href="slidebanner.do">
									<li><a href="#"><i class="fa fa-angle-double-right"></i>HOT</a></li>
									<li><a href="#"><i
					...
					<li class="treeview"><a href="#"> <i class="fa fa-laptop"></i>
						...
						<ul class="treeview-menu">
							<li><a href="#"><i class="fa fa-angle-double-right"></i>환전</a></li>
							<li><a href="#"><i class="fa fa-angle-double-right"></i>포인트
									관리</a></li>
					...
					<li class="treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li><a href="#"><i class="fa fa-angle-double-right"></i>공지사항</a></li>
							<li><a href="#"><i class="fa fa-angle-double-right"></i>QnA</a></li>
							...
							<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
								...
								<ul class="treeview-menu">
									...
									<li><a href="#"><i class="fa fa-angle-double-right"></i>광고비용
											산출</a></li>
									<li><a href="#"><i class="fa fa-angle-double-right"></i>광고
											신청</a></li>
								</ul></li>
						</c:when>

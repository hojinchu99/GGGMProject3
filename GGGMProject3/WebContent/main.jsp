    ...
    <body class="skin-black">
        ...
        <script type="text/javascript">
        	$(function(){
        		...
        		$(".sidebar-menu li:nth-child("+divByThree+")").addClass("active");
        		$(".sidebar-menu li:nth-child("+divByThree+") ul li:nth-child(1)").removeClass("active");
        		$(".sidebar-menu li:nth-child("+divByThree+") ul li:nth-child(2)").removeClass("active");
        		$(".sidebar-menu li:nth-child("+divByThree+") ul li:nth-child(3)").removeClass("active");
        		$(".sidebar-menu li:nth-child("+divByThree+") ul li:nth-child("+liNo+")").addClass("active");
        	});
        </script>
